...
public class frmGuardarBibliografia extends javax.swing.JFrame {
    ...
    public void insertarBibliografia() {
        ...
        try {
            ...
            if (bibliografiaServicios.insertar(objBibliografia)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmGuardarBibliografia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmGuardarBibliografia().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox cbTBibliografia;
    private org.freixas.jcalendar.JCalendarCombo fechaPublicacion;
